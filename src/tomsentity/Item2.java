...
public class Item2 implements Serializable {
     ...
     */
	@GeneratedValue(strategy=SEQUENCE, generator = "ITEMSEQ2")
	@Id    	
	@SequenceGenerator(name = "ITEMSEQ2")
	private Integer ItemNO;
	public Employee2 getTest() {
		return test;
	}


	public void setTest(Employee2 test) {
		this.test = test;
	}
    ...
    // target is obvious, so not further specifying
	@ManyToOne
	Employee2 test;
